---
name: ops-linux-troubleshooter
description: Linux 系统问题排查：CPU/内存/磁盘/网络问题诊断与解决。使用场景：系统响应慢、服务异常、磁盘空间不足、网络不通、进程异常。
tags: [linux, troubleshooting, devops, system-admin]
---
